        ...
        >
            ...
            <div>
                <p className="mb-4">
                    ...
                    neighborhood{" "}
                    <PlainLink href="/">Software Engineer</PlainLink>.
                </p>
                <p className="mb-4">
                    When I&apos;m not coding, you can find me exploring the vast
                    realms of{" "}
                    ...
                    navigating the <PlainLink href="/">blockchain</PlainLink>{" "}
                    universe.
                </p>
                <p className="mb-4">
                    I&apos;ve got a knack for{" "}
                    <PlainLink href="/">finance</PlainLink>, and I love to{" "}
                    <PlainLink href="/">embark on adventures</PlainLink> around
                    the globe. Let&apos;s create some magic with code!
                </p>
                <p>
                    I always like to introduce some gamification 🕹️ into my
                    projects. Here I would like to summarize my work path
                    through the{" "}
