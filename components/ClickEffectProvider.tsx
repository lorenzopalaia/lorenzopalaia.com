      ...
      <AnimatePresence>
        {clicks.map((click) => (
          <React.Fragment key={click.id}>
            ...
            >
              <div className="h-12 w-12 rounded-full border-2 border-sky-400" />
            </motion.div>
            ...
            {[...Array(12)].map((_, i) => (
              <motion.div
                key={i}
                className="pointer-events-none fixed z-50 h-2 w-2 rounded-full bg-gradient-to-r from-sky-400 to-purple-500"
                style={{
                  left: click.x,
                  top: click.y,
                }}
