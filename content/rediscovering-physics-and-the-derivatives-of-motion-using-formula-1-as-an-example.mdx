...
<TOCInline sections={[
  ...
  { url: "#from-zero-to-motion-the-chain-of-derivatives", title: "From Zero to Motion: The Chain of Derivatives" },
  { url: "#practical-examples-and-beyond", title: "Practical Examples and Beyond" },
