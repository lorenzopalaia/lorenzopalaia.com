...
image: "/blog/images/posts/advent-of-code-2024-my-journey/aoc24.jpeg"
...
<TOCInline
  sections={[
    { url: "#my-advent-of-code-experience", title: "My Advent of Code Experience" },
    { url: "#tools-of-the-trade", title: "Tools of the Trade" },
    { url: "#the-format-strengths-and-weaknesses", title: "The Format: Strengths and Weaknesses" },
